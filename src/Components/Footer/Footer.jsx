    ...
    return (
        <div>
            <footer className="footer p-10 bg-base-100 text-base-content">
                <nav>
                    <h6 className="footer-title text-sky-600">Contest</h6>
                ...
                <nav>
                    ...
                    <a className="link link-hover">Helpful</a>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <aside className="items-center grid-flow-col">
                    <img src="https://i.ibb.co/cYYQdms/black-yellow-minimalist-Idea-Logo.png" className="h-20 w-20" alt="" />
                    <p><span className="text-sky-600">IDEA BATTLE</span><br /><span>Copyright © 2008-2024, IdeaBattle LLC</span></p>
                </aside>
